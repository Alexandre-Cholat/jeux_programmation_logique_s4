...
/*Case 1: E2 + 1 = E1 (special consecutive case)*/
jeuxV2(Equipe1, Equipe2, History, LastChoices, NbDeParties, Score1, Score2, FinalScore1, FinalScore2) :-
    joue(Equipe1, History, E1),
    joue(Equipe2, History, E2),
    E2 + 1 =:= E1,
    /* In consecutive case, normal rules apply (sum goes to lower number player) */
...
/* Case 2: E1 + 1 = E2 (special consecutive case) */
jeuxV2(Equipe1, Equipe2, History, LastChoices, NbDeParties, Score1, Score2, FinalScore1, FinalScore2) :-
    joue(Equipe1, History, E1),
    joue(Equipe2, History, E2),
    E1 + 1 =:= E2,
